function createUnityInstance(e, t, r) {
    function n(e, r) {
        if (!n.aborted && t.showBanner) return "error" == r && (n.aborted = !0),
        t.showBanner(e, r);
        switch (r) {
        case "error":
            console.error(e);
    ...
    function s(e, t) {
        if ("symbolsUrl" != e) {
            ...
            for (var e in f.downloadProgress) {
                ...
                i++,
                n.lengthComputable ? (a += n.loaded, o += n.total, s++) : n.finished || l++
            }
    ...
    function l(e, t, r) {
        for (var n in m) if (m[n].hasUnityMarker(e)) {
            ...
            var a = m[n];
            if (!a.worker) {
                var o = URL.createObjectURL(new Blob(["this.require = ", a.require.toString(), "; this.decompress = ", a.decompress.toString(), "; this.onmessage = ",
                function(e) {
                    var t = {
                        id: e.data.id,
                ...
                a.worker.onmessage = function(e) {
                    return e.data.ready ? void URL.revokeObjectURL(o) : (this.callbacks[e.data.id](e.data.decompressed), void delete this.callbacks[e.data.id])
                },
                a.worker.callbacks = {},
                a.worker.nextCallbackId = 0
            }
            var i = a.worker.nextCallbackId++;
            return a.worker.callbacks[i] = r,
    ...
    function d(e) {
        return new Promise(function(t, r) {
            s(e);
            var a = f.companyName && f.productName ? new f.XMLHttpRequest({
            ...
            function(r) {
                s(e, r),
                l(new Uint8Array(a.response), f[e], t)
            }),
        ...
        f.preRun.push(function() {
            ...
            e.then(function(e) {
                ...
                for (r += 4; r < a;) {
                    ...
                    r += s;
                    for (var d = 0,
                    u = l.indexOf("/", d) + 1; u > 0; d = u, u = l.indexOf("/", d) + 1) f.FS_createPath(l.substring(0, d), l.substring(d, u - 1), !0, !0);
    ...
    f.SystemInfo = function() {
        ...
        for (var t, r, n, a, o, i, s = navigator.userAgent + " ",
        l = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]], d = 0; d < l.length; ++d) if (r = e(l[d][0] + "[/ ](.*?)[ \\)]", s, 1)) {
            t = l[d][1];
            break
        }
        ...
        o && (gl = o.getContext("webgl2"), glVersion = gl ? 2 : 0, gl || (gl = o && o.getContext("webgl")) && (glVersion = 1), gl && (i = gl.getExtension("WEBGL_debug_renderer_info") && gl.getParameter(37446) || gl.getParameter(7937)));
    ...
    f.XMLHttpRequest = function() {
        ...
        function o(t) {
            ...
            function() {
                var t = this.xhr,
                r = this.cache;
                r.enabled && !r.revalidated && (304 == t.status ? (r.result.revalidated = r.result.accessed, r.revalidated = !0, d.execute(s.name, "put", [r.result]), e("'" + r.result.url + "' successfully revalidated and served from the indexedDB cache")) : 200 == t.status ? (r.result = a(r.result.url, r.company, r.product, r.result.accessed, t), r.revalidated = !0, d.execute(s.name, "put", [r.result],
                function(t) {
        ...
        n.prototype.execute = function(e, t, r, n, a) {
            if (this.database) try {
                var o = this.database.transaction([e], ["put", "delete", "clear"].indexOf(t) != -1 ? "readwrite": "readonly").objectStore(e);
        ...
        o.prototype.send = function(t) {
            ...
            a = this.cache,
            o = arguments;
            return a.enabled = a.enabled && "arraybuffer" == n.responseType && !t,
            a.enabled ? void d.execute(s.name, "get", [a.result.url],
            function(t) {
                if (!t || t.version != s.version) return void n.send.apply(n, o);
                if (a.result = t, a.result.accessed = Date.now(), "immutable" == a.control) a.revalidated = !0,
                ...
                else if (r(a.result.url) && (a.result.responseHeaders["Last-Modified"] || a.result.responseHeaders.ETag)) {
                    var i = new XMLHttpRequest;
                    i.open("HEAD", a.result.url),
                    i.onload = function() {
                        a.revalidated = ["Last-Modified", "ETag"].every(function(e) {
                            return ! a.result.responseHeaders[e] || a.result.responseHeaders[e] == i.getResponseHeader(e)
                        }),
                        a.revalidated ? (a.result.revalidated = a.result.accessed, d.execute(s.name, "put", [a.result]), n.dispatchEvent(new Event("load")), e("'" + a.result.url + "' successfully revalidated and served from the indexedDB cache")) : n.send.apply(n, o)
                    },
                    i.onerror = function() {
                        n.send.apply(n, o)
                    },
                    i.send()
                } else a.result.responseHeaders["Last-Modified"] ? (n.setRequestHeader("If-Modified-Since", a.result.responseHeaders["Last-Modified"]), n.setRequestHeader("Cache-Control", "no-cache")) : a.result.responseHeaders.ETag && (n.setRequestHeader("If-None-Match", a.result.responseHeaders.ETag), n.setRequestHeader("Cache-Control", "no-cache")),
                n.send.apply(n, o)
            },
            function(e) {
                n.send.apply(n, o)
        ...
        o.prototype.open = function(e, r, n, o, i) {
            return this.cache.result = a(t(r), this.cache.company, this.cache.product, Date.now()),
            this.cache.enabled = ["must-revalidate", "immutable"].indexOf(this.cache.control) != -1 && "GET" == e && this.cache.result.url.match("^https?://") && ("undefined" == typeof n || n) && "undefined" == typeof o && "undefined" == typeof i,
        ...
        for (var c in u) o.prototype.hasOwnProperty(c) || !
        function(e) {
            Object.defineProperty(o.prototype, e, "function" == typeof u[e] ? {
                value: function() {
            ...
            require: function(e) {
                var t = {
                    "inflate.js": function(e, t, r) {
                        ...
                        n.prototype.push = function(e, t) {
                            ...
                            do {
                                ...
                                f.next_out && (0 !== f.avail_out && r !== d.Z_STREAM_END && (0 !== f.avail_in || n !== d.Z_FINISH && n !== d.Z_SYNC_FLUSH) || ("string" === this.options.to ? (a = l.utf8border(f.output, f.next_out), o = f.next_out - a, u = l.buf2string(f.output, a), f.next_out = o, f.avail_out = p - o, o && s.arraySet(f.output, f.output, a, o, 0), this.onData(u)) : this.onData(s.shrinkBuf(f.output, f.next_out)))), 0 === f.avail_in && 0 === f.avail_out && (m = !0)
                            } while (( f . avail_in > 0 || 0 === f . avail_out ) && r !== d.Z_STREAM_END);
                            return r === d.Z_STREAM_END && (n = d.Z_FINISH),
                            n === d.Z_FINISH ? (r = i.inflateEnd(this.strm), this.onEnd(r), this.ended = !0, r === d.Z_OK) : n !== d.Z_SYNC_FLUSH || (this.onEnd(d.Z_OK), f.avail_out = 0, !0)
                        },
                    ...
                    "utils/common.js": function(e, t, r) {
                        ...
                        var a = {
                            ...
                            flattenChunks: function(e) {
                                ...
                                for (i = new Uint8Array(n), a = 0, t = 0, r = e.length; t < r; t++) o = e[t],
                                i.set(o, a),
                                a += o.length;
                                return i
                            }
                        ...
                        r.setTyped = function(e) {
                            e ? (r.Buf8 = Uint8Array, r.Buf16 = Uint16Array, r.Buf32 = Int32Array, r.assign(r, a)) : (r.Buf8 = Array, r.Buf16 = Array, r.Buf32 = Array, r.assign(r, o))
                        },
                        r.setTyped(n)
                    },
                    "utils/strings.js": function(e, t, r) {
                        "use strict";
                        function n(e, t) {
                            if (t < 65537 && (e.subarray && i || !e.subarray && o)) return String.fromCharCode.apply(null, a.shrinkBuf(e, t));
                            for (var r = "",
                        ...
                        r.string2buf = function(e) {
                            var t, r, n, o, i, s = e.length,
                            l = 0;
                            for (o = 0; o < s; o++) r = e.charCodeAt(o),
                            55296 === (64512 & r) && o + 1 < s && (n = e.charCodeAt(o + 1), 56320 === (64512 & n) && (r = 65536 + (r - 55296 << 10) + (n - 56320), o++)),
                            l += r < 128 ? 1 : r < 2048 ? 2 : r < 65536 ? 3 : 4;
                            for (t = new a.Buf8(l), i = 0, o = 0; i < l; o++) r = e.charCodeAt(o),
                            55296 === (64512 & r) && o + 1 < s && (n = e.charCodeAt(o + 1), 56320 === (64512 & n) && (r = 65536 + (r - 55296 << 10) + (n - 56320), o++)),
                        ...
                        r.buf2string = function(e, t) {
                            var r, a, o, i, l = t || e.length,
                            d = new Array(2 * l);
                            for (a = 0, r = 0; r < l;) if (o = e[r++], o < 128) d[a++] = o;
                            else if (i = s[o], i > 4) d[a++] = 65533,
                            r += i - 1;
                            else {
                                for (o &= 2 === i ? 31 : 3 === i ? 15 : 7; i > 1 && r < l;) o = o << 6 | 63 & e[r++],
                                i--;
                                i > 1 ? d[a++] = 65533 : o < 65536 ? d[a++] = o: (o -= 65536, d[a++] = 55296 | o >> 10 & 1023, d[a++] = 56320 | 1023 & o)
                            }
                            return n(d, a)
                        },
                    ...
                    "zlib/inflate.js": function(e, t, r) {
                        ...
                        function o(e) {
                            var t;
                            return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = D, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new g.Buf32(be), t.distcode = t.distdyn = new g.Buf32(me), t.sane = 1, t.back = -1, B) : O
                        }
                        function i(e) {
                            var t;
                        ...
                        function l(e, t) {
                            var r, n;
                            return e ? (n = new a, e.state = n, n.window = null, r = s(e, t), r !== B && (e.state = null), r) : O
                        }
                        function d(e) {
                            return l(e, ge)
                        }
                        ...
                        function c(e, t, r, n) {
                            var a, o = e.state;
                            return null === o.window && (o.wsize = 1 << o.wbits, o.wnext = 0, o.whave = 0, o.window = new g.Buf8(o.wsize)),
                            n >= o.wsize ? (g.arraySet(o.window, t, r - o.wsize, o.wsize, 0), o.wnext = 0, o.whave = o.wsize) : (a = o.wsize - o.wnext, a > n && (a = n), g.arraySet(o.window, t, r - n, a, o.wnext), n -= a, n ? (g.arraySet(o.window, t, r - n, n, 0), o.wnext = n, o.whave = o.wsize) : (o.wnext += a, o.wnext === o.wsize && (o.wnext = 0), o.whave < o.wsize && (o.whave += a))),
                            0
                        }
                        function f(e, t) {
                            var r, a, o, i, s, l, d, f, h, p, b, m, w, be, me, we, ge, ve, ye, ke, xe, _e, Se, Ee, Ce = 0,
                            Ue = new g.Buf8(4),
                            ...
                            case z:
                                ...
                                512 & r.flags && (Ue[0] = 255 & f, Ue[1] = f >>> 8 & 255, r.check = y(r.check, Ue, 2, 0)),
                                f = 0,
                                h = 0,
                                r.mode = F;
                            case F:
                                ...
                                512 & r.flags && (Ue[0] = 255 & f, Ue[1] = f >>> 8 & 255, Ue[2] = f >>> 16 & 255, Ue[3] = f >>> 24 & 255, r.check = y(r.check, Ue, 4, 0)),
                                f = 0,
                                h = 0,
                                r.mode = P;
                            case P:
                            ...
                            case Z:
                                ...
                                r.mode = M;
                            case M:
                                if (1024 & r.flags && (m = r.length, m > l && (m = l), m && (r.head && (xe = r.head.extra_len - r.length, r.head.extra || (r.head.extra = new Array(r.head.extra_len)), g.arraySet(r.head.extra, a, i, m, xe)), 512 & r.flags && (r.check = y(r.check, a, m, i)), l -= m, i += m, r.length -= m), r.length)) break e;
                                r.length = 0,
                                r.mode = j;
                            case j:
                                if (2048 & r.flags) {
                                    ...
                                    while (xe && m < l);
                                    if (512 & r.flags && (r.check = y(r.check, a, m, i)), l -= m, i += m, xe) break e
                            ...
                            case Y:
                                ...
                                if (r.length = 65535 & f, f = 0, h = 0, r.mode = Q, t === R) break e;
                            case Q:
                                r.mode = J;
                            case J:
                                if (m = r.length) {
                            ...
                            case ee:
                                for (; r.have < r.ncode;) {
                                    ...
                                    r.lens[Re[r.have++]] = 7 & f,
                                    f >>>= 3,
                                    h -= 3
                                }
                                for (; r.have < 19;) r.lens[Re[r.have++]] = 0;
                            ...
                            case se:
                                ...
                                if (m = b - d, r.offset > m) {
                                    ...
                                    m > r.wnext ? (m -= r.wnext, w = r.wsize - m) : w = r.wnext - m,
                            ...
                            case de:
                                if (r.wrap) {
                                    ...
                                    if (b -= d, e.total_out += b, r.total += b, b && (e.adler = r.check = r.flags ? y(r.check, o, b, s - b) : v(r.check, o, b, s - b)), b = d, (r.flags ? f: n(f)) !== r.check) {
                            ...
                            r.hold = f,
                            r.bits = h,
                            (r.wsize || b !== e.avail_out && r.mode < fe && (r.mode < de || t !== C)) && c(e, e.output, e.next_out, b - e.avail_out) ? (r.mode = he, A) : (p -= e.avail_in, b -= e.avail_out, e.total_in += p, e.total_out += b, r.total += b, r.wrap && b && (e.adler = r.check = r.flags ? y(r.check, o, b, e.next_out - b) : v(r.check, o, b, e.next_out - b)), e.data_type = r.bits + (r.last ? 64 : 0) + (r.mode === K ? 128 : 0) + (r.mode === re || r.mode === Q ? 256 : 0), (0 === p && 0 === b || t === C) && _e === B && (_e = I), _e)
                        }
                        function h(e) {
                        ...
                        function p(e, t) {
                            var r;
                            return e && e.state ? (r = e.state, 0 === (2 & r.wrap) ? O: (r.head = t, t.done = !1, B)) : O
                        }
                        function b(e, t) {
                            var r, n, a, o = t.length;
                            return e && e.state ? (r = e.state, 0 !== r.wrap && r.mode !== X ? O: r.mode === X && (n = 1, n = v(n, t, o, 0), n !== r.check) ? H: (a = c(e, t, o, o)) ? (r.mode = he, A) : (r.havedict = 1, B)) : O
                        }
                    ...
                    "zlib/inffast.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t) {
                            var r, o, i, s, l, d, u, c, f, h, p, b, m, w, g, v, y, k, x, _, S, E, C, U, R;
                            r = e.state,
                            o = e.next_in,
                            U = e.input,
                            i = o + (e.avail_in - 5),
                            ...
                            y = (1 << r.distbits) - 1;
                            e: do {
                                m < 15 && (b += U[o++] << m, m += 8, b += U[o++] << m, m += 8), k = w[b & v];
                                t: for (;;) {
                                    if (x = k >>> 24, b >>>= x, m -= x, x = k >>> 16 & 255, 0 === x) R[s++] = 65535 & k;
                                    else {
                                        if (! (16 & x)) {
                                            if (0 === (64 & x)) {
                                                k = w[(65535 & k) + (b & (1 << x) - 1)];
                                        ...
                                        _ = 65535 & k,
                                        x &= 15,
                                        x && (m < x && (b += U[o++] << m, m += 8), _ += b & (1 << x) - 1, b >>>= x, m -= x),
                                        m < 15 && (b += U[o++] << m, m += 8, b += U[o++] << m, m += 8),
                                        k = g[b & y];
                                        r: for (;;) {
                                            ...
                                            if (S = 65535 & k, x &= 15, m < x && (b += U[o++] << m, m += 8, m < x && (b += U[o++] << m, m += 8)), S += b & (1 << x) - 1, S > u) {
                                                e.msg = "invalid distance too far back",
                                                r.mode = n;
                                                break e
                                            }
                    ...
                    "zlib/inftrees.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, p, b, m, w, g) {
                            var v, y, k, x, _, S, E, C, U, R = g.bits,
                            B = 0,
                            T = 0,
                            L = 0,
                            O = 0,
                            ...
                            for (H = R, O = a; O >= 1 && 0 === Z[O]; O--);
                            if (H > O && (H = O), 0 === O) return b[m++] = 20971520,
                            b[m++] = 20971520,
                            g.bits = 1,
                            0;
                            for (L = 1; L < O && 0 === Z[L]; L++);
                            for (H < L && (H = L), N = 1, B = 1; B <= a; B++) if (N <<= 1, N -= Z[B], N < 0) return - 1;
                            if (N > 0 && (e === s || 1 !== O)) return - 1;
                            for (M[1] = 0, B = 1; B < a; B++) M[B + 1] = M[B] + Z[B];
                            for (T = 0; T < p; T++) 0 !== t[r + T] && (w[M[t[r + T]]++] = T);
                            if (e === s ? (F = j = w, S = 19) : e === l ? (F = u, P -= 257, j = c, W -= 257, S = 256) : (F = f, j = h, S = -1), z = 0, T = 0, B = L, _ = m, A = H, I = 0, k = -1, D = 1 << H, x = D - 1, e === l && D > o || e === d && D > i) return 1;
                            for (;;) {
                                E = B - I,
                                w[T] < S ? (C = 0, U = w[T]) : w[T] > S ? (C = j[W + w[T]], U = F[P + w[T]]) : (C = 96, U = 0),
                                v = 1 << B - I,
                                y = 1 << A,
                                L = y;
                                do y -= v,
                                ...
                                while (0 !== y);
                                for (v = 1 << B - 1; z & v;) v >>= 1;
                                if (0 !== v ? (z &= v - 1, z += v) : z = 0, T++, 0 === --Z[B]) {
                                    if (B === O) break;
                                    B = t[r + w[T]]
                                }
                                if (B > H && (z & x) !== k) {
                                    for (0 === I && (I = H), _ += L, A = B - I, N = 1 << A; A + I < O && (N -= Z[A + I], !(N <= 0));) A++,
                                    N <<= 1;
                                    if (D += 1 << A, e === l && D > o || e === d && D > i) return 1;
                                    k = z & x,
                                    b[k] = H << 24 | A << 16 | _ - m | 0
                                }
                            }
                            return 0 !== z && (b[_ + z] = B - I << 24 | 64 << 16 | 0),
                            g.bits = H,
                            0
                        }
                    }
                ...
                o = function(e, t) {
                    var r = t.match(/^\//) ? null: e ? t.match(/^\.\.?\//) ? n(e.folder + t) : a(e, t) : n(t);
                    if (!r) throw "module not found: " + t;
                    return r.exports || (r.parent = e, r(o.bind(null, r), r, r.exports = {})),
                    r.exports
                };
                return o(null, e)
            },
